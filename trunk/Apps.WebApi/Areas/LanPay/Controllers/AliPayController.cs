...
namespace Apps.WebApi.Areas.LanPay.Controllers
{
    public class AliPayController : ApiController
    {
        ...
        private static string receiveUrl = "http://154.8.159.50:1693/api/AliPay/AliCallBack";
        protected static ZPayConfig ZPayConfig { get; set; } = new ZPayConfig()
        {
            ...
            AppPublicKey = "",
        };

        private static readonly ZPayTradeApi _api = new ZPayTradeApi(ZPayConfig);
        // 支付结果回调接收
        [HttpPost]
        public object AliCallBack(ZPayCallBackResp pay)
        {
            var dics = Request.GetQueryNameValuePairs().ToDictionary(f => f.Key, f => f.Value.ToString());

...
public partial class DBContainer : DbContext
{
    ...
    public virtual DbSet<SysErCi> SysErCi { get; set; }

    public virtual DbSet<SysHelps> SysHelps { get; set; }

    public virtual DbSet<SysJiaPu> SysJiaPu { get; set; }

    public virtual DbSet<SysLevels> SysLevels { get; set; }
    ...
    public virtual int P_Sys_InsertSysRight(string id)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("P_Sys_InsertSysRight", idParameter);
    }
    ...
    public virtual int P_Sys_EveryMonth()
    {
